...
2. Pull the following required Docker images onto your air-gapped environment:
    ...
    * docker.io/portworx/pxcentral-onprem-ui-frontend:1.2.3
    * docker.io/portworx/pxcentral-onprem-ui-backend:1.2.3
    * docker.io/portworx/pxcentral-onprem-ui-lhbackend:1.2.3
    * docker.io/portworx/px-backup:1.2.3
