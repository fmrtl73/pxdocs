...
weight: 20000
aliases:
    - /portworx-install-with-kubernetes/autopilot/use-cases/autogrow-pool/
---
...
{{<info>}}
**NOTE**: You can also use the `resize-disk` scale type to expand Portworx storage pools. See [the Autopilot reference documentation](/operations/operate-kubernetes/autopilot/reference/#openstorage-io-action-storagepool-expand) for details on each parameter for the Autopilot expand action.
{{</info>}}
