...
noicon: true
aliases:
    - /portworx-install-with-kubernetes/application-install-with-kubernetes/postgresql/
---
...
* **Stork**. Refer to the [Using Stork with Portworx](/operations/operate-kubernetes/storage-operations/stork/) page for details about installing Stork.
