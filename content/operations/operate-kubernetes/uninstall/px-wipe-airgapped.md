...
hidden: true
aliases:
    - /portworx-install-with-kubernetes/operate-and-maintain-on-kubernetes/uninstall/px-wipe-airgapped/
---
...
If you followed the [air-gapped install](/install-portworx/on-premises/airgapped/) instructions, you should already have all the necessary images available for your nodes.
