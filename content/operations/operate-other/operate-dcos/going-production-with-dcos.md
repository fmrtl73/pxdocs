...
aliases:
    - /install-with-other/dcos/operate-and-maintain/going-production-with-dcos/
---
{{<info>}}
...
* Using DC/OS, if Portworx is installed as a framework, you can also scale a Portworx cluster by using the DC/OS Portworx [framework](/operations/operate-other/operate-dcos/volume-scaling/).
...
#### Portworx Software Upgrades
  ...
  * If you are using the the Portworx DC/OS framework for deploying Portworx and running Portworx as OCI format container, follow this [link](/operations/operate-other/operate-dcos/upgrade-oci) to perform the upgrades.
  * If you are running Portworx as a systemd service, follow this [link](/operations/operate-other/operate-dcos/upgrade).
...
* Ensure there are [cloudsnaps](/operations/operate-other/operate-dcos/upgrade) that are taken.
