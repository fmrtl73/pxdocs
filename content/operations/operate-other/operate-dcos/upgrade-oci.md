...
linkTitle: Upgrade
aliases:
    - /install-with-other/dcos/operate-and-maintain/upgrade-oci/
---
{{<info>}}
...
This guide walks through upgrading Portworx deployed on DCOS through the framework available in the DCOS catalog. If you are using a Portworx framework version older than 1.2*, refer to [this guide](/operations/operate-other/operate-dcos/upgrade) to upgrade Portworx.
