...
In VPC clusters, make sure to select a [virtual server flavor](https://cloud.ibm.com/docs/vpc-on-classic-vsi?topic=vpc-on-classic-vsi-profiles) that meets the [minimum hardware requirements](/install-portworx/prerequisites/) for Portworx. For optimal performance, the flavor that you choose should have a network speed of 10 Gbps or more; Portworx requires a minimum of 1 Gbps. No VPC flavors include raw and unformatted block storage devices.
