...
## Step 2: Create/Configure Portworx-ready Rancher Hosts

{{<info>}}Portworx requires that Rancher hosts have at least one non-root disk or partition to contribute.{{</info>}}

For trial/demo purposes, Portworx, Inc. has created “Portworx-ready” AMI images in AWS:
...
* Use Disks: -s /dev/xvdb, for the referenced AMI images; otherwise see storage options from [here](/install-portworx/install-with-other/docker)
